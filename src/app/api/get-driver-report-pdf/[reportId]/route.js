// app/api/get-driver-report-pdf/[reportId]/route.js
...
export async function GET(request, { params }) {
  ...
  const apiUrl = `${process.env.API_BASE_URL}/${process.env.API_GET_DRIVER_REPORT_PDF}${reportId}`;
  ...
  try {
    ...
    let fileName = `4Tracks_driver_report_${reportId}.pdf`;
