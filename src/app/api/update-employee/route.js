...
export async function POST(request) {
  ...
  const apiUrl = `${process.env.API_BASE_URL}${process.env.API_OFFICE_EMPLOYEES_URL}`;
...
export async function PATCH(request) {
  ...
  const apiUrl = `${process.env.API_BASE_URL}${process.env.API_OFFICE_EMPLOYEES_URL}${driverId}/`;
