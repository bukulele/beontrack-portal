...
export async function POST(request) {
  ...
  const apiUrl = `${process.env.API_BASE_URL}${process.env.API_GET_VIOLATION_TICKETS}`;
...
export async function PATCH(request) {
  ...
  const apiUrl = `${process.env.API_BASE_URL}${process.env.API_GET_VIOLATION_TICKETS}${incidentId}/`;
...
export async function DELETE(request) {
  ...
  const apiUrl = `${process.env.API_BASE_URL}${process.env.API_GET_VIOLATION_TICKETS}${claimId}/`;
