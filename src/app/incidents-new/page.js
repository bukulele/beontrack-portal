...
function IncidentsNewPage() {
  ...
  const columns = INCIDENTS_TABLE.map((col) => ({
    field: col.field,
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-8">
      <div className="max-w-7xl mx-auto">
        <Card className="mb-6">
          <CardHeader>
            <CardTitle className="text-2xl">Incidents - New Universal Card System</CardTitle>
            <p className="text-sm text-muted-foreground mt-2">
              Testing Phase 5B: IncidentCard with 2 tabs (General + Checklist)
            </p>
          </CardHeader>
        </Card>
...
export default IncidentsNewPage;
