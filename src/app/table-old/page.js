...
} from "../tableData/driversTable";
import { OFFICE_TABLE_FIELDS_SAFETY } from "../tableData/officeEmployeesTable";
import { TRUCKS_TABLE_FIELDS } from "../tableData/trucksTable";
import { DRIVER_REPORT_TABLE_FIELDS } from "../tableData/driverReportsTable";
...
import { EQUIPMENT_TABLE_FIELDS } from "../tableData/equipmentTable";
import { InfoCardProvider } from "../context/InfoCardContext";
import { INCIDENTS_TABLE } from "../tableData/incidentsTable";
...
} from "../tableData/fuelReportTable";
import { VIOLATIONS_TABLE } from "../tableData/violationsTable";
import { WCB_TABLE } from "../tableData/wcbTable";
          ...
          {status === "authenticated" &&
            ...
            !userRoles.includes("no roles") && (
              <div className="flex flex-col justify-center min-h-screen max-h-screen w-screen bg-white">
                <div className="flex w-full h-auto max-h-full flex-1 overflow-hidden divide-x">
                  <Menu
                  ...
                  menuPointChosen !== "all_drivers_data" ? (
                    ...
                    <div className="w-full min-h-full max-h-full px-1 py-4 flex justify-end">
                      <Button
                        content={
                  ...
                  menuPointChosen === "all_drivers_data" ? (
                    ...
                    <div className="gap-1 w-full min-h-full max-h-full flex flex-col">
                      <div className="px-1 py-4 flex justify-end">
                        <Button
                          content={
                            <div className="flex items-center gap-1">
                              <FontAwesomeIcon icon={faRightFromBracket} />
